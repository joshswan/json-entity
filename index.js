...
/**
 * Entity constructor
 * Creates a new Entity instance using the definition objects passed as arguments.
 * @param {Object}  entityDefinitions Entity definitions object(s)
 * @return {Entity}
 */
function Entity(...entityDefinitions) {
  // Return an instantiated Entity if called directly
  if (!(this instanceof Entity)) return new Entity(...entityDefinitions);
 ...
 * @return {Boolean}
 */
Entity.isEntity = function isEntity(entity) {
 ...
 * @return {Entity}
 */
Entity.prototype.extend = function extend(...entityDefinitions) {
 ...
 */
Entity.prototype.expose = function expose(property, options = {}) {
 ...
 * Only properties that have been exposed in the Entity will be included in the resulting object(s)
 * and any specified options will be applied during representation.
 * @param  {Array|Object} data         Data to be represented
 * @param  {Object}       [options={}] Options (passed to if/value functions & nested Entities)
 * @return {Array|Object}
 */
Entity.prototype.represent = function represent(data, options = {}) {
